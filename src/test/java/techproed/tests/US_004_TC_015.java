...
public class US_004_TC_015 {
    ...
    @Test
    public void US_004_TC_015() throws IOException {
        homePage = new HomePage();
        register_page = new Register_Page();
        ...
        //User does not enter company name
        //shippingAddressPage.companyNameInput.sendKeys(faker.company().name());
        ReusableMethods.getScreenshot("without company name");
        ReusableMethods.waitFor(3);
