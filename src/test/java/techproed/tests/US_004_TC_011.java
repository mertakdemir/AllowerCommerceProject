...
public class US_004_TC_011 {
    ...
    @Test
    public void US_004_TC_011() throws IOException {
        ...
        shippingAddressPage.zipCodeInput.sendKeys("a");
        ReusableMethods.waitFor(2);
        ReusableMethods.getScreenshot("Invalid ZIP Code");
        ReusableMethods.waitFor(1);
