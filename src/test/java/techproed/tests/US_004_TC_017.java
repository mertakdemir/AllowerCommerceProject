...
public class US_004_TC_017 {
    ...
    @Test
    public void US_004_TC_017() throws IOException {
        homePage = new HomePage();
        register_page = new Register_Page();
        ...
        //User does not enter apartment name
        //shippingAddressPage.addressApartmentOrSuiteInput.sendKeys(faker.address().buildingNumber());
        ReusableMethods.getScreenshot("without apartment name");
        ReusableMethods.waitFor(3);
