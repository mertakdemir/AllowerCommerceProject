...
public class US_004_TC_019 {
    ...
    @Test
    public void US_004_TC_019() throws IOException {
        homePage = new HomePage();
        register_page = new Register_Page();
